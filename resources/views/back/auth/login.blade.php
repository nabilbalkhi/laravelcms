...
<head>
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>Doctor Online | Login to Admin Panel</title>
    <meta name="viewport"
                ...
                <div class="h-100 no-gutters row">
                    ...
                    <div class="h-100 d-flex bg-white justify-content-center align-items-center col-md-12 col-lg-8">
                        <div class="mx-auto app-login-box col-sm-12 col-md-10 col-lg-9">
                            <div class="app-logo"style=" height: 52px;
    width: 184px; background: url({{asset('front/images/logo.png')}});"></div>
                            <h4 class="mb-0">
...
<!-- Mirrored from demo.dashboardpack.com/architectui-html-pro/pages-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 May 2020 17:37:48 GMT -->
