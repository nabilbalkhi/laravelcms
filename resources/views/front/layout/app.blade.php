...
<!--header-->	<div class="settings-panel">
		<div class="settings-panel-buy-now">
			<a href="https://themeforest.net/item/medin-medical-clinic-html-template/22564438?s_rank=1" target="_blank" class="settings-panel-btn btn-primary">
				<img src="{{asset('front/color/icon-cart.png')}}" alt=""> Purchase Now
			</a>
		</div>
		<div class="settings-panel-colorswatch js-settings-panel-item">
			<div class="settings-panel-btn btn-primary js-settings-panel-btn">
				<img src="{{asset('front/color/icon-settings.png')}}" alt="">
			</div>
		...
		<div class="settings-panel-layout js-settings-panel-item">
			<div class="settings-panel-btn btn-primary js-settings-panel-btn">
				<img src="{{asset('front/color/icon-layout.png')}}" alt="">
			</div>
			<div class="settings-panel-inside">
				<a href="http://websmirno.site/medin/html/dentco-html/"><img src="{{asset('front/color/screen-layout-1.png')}}" alt=""></a>
				<a href="http://websmirno.site/medin/html/surgery-html/"><img src="{{asset('front/color/screen-layout-2.png')}}" alt=""></a>
				<a href="http://websmirno.site/medin/html/medol-html/"><img src="{{asset('front/color/screen-layout-3.png')}}" alt=""></a>
        <a href="index-2.html" class="active"><img src="{{asset('front/color/screen-layout-4.png')}}" alt=""></a>        <a href="http://websmirno.site/medin/html/medeye-html/"><img src="{{asset('front/color/screen-layout-5.png')}}" alt=""></a>
        <a href="http://websmirno.site/medin/html/medlab-html/"><img src="{{asset('front/color/screen-layout-6.png')}}" alt=""></a><a href="http://websmirno.site/medin/html/weightloss-html/"><img src="{{asset('front/color/screen-layout-7.png')}}" alt=""></a>
			</div>
		</div>
	</div>
<!--header-->
		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-auto d-flex align-items-center">
					...
					<div class="header-info"><i class="icon-black-envelope"></i><a href="mailto:info@medera.net">info@medera.net</a></div>
				</div>
		...
		<div class="container">
			<div class="row align-items-lg-center">
				...
				<div class="col-lg-auto col-lg-2 d-flex align-items-lg-center">
					<a href="index.html" class="header-logo"><img src="{{asset('front/images/logo.png')}}" alt="" class="img-fluid"></a>
				</div>
...
<div class="page-content">
	...
	<div class="section mt-0">
		...
		<div id="mainSliderWrapper">
			...
			<div class="main-slider mb-0 arrows-white arrows-bottom" id="mainSlider" data-slick='{"arrows": false, "dots": true}'>
				<div class="slide">
					<div class="img--holder" data-bg="{{asset('front/images/content/slider/slide-01.jpg')}}"></div>
				...
				<div class="slide">
					<div class="img--holder" data-bg="{{asset('front/images/content/slider/slide-02.jpg')}}"></div>
					<div class="slide-content center">
						<div class="vert-wrap container">
							<div class="vert">
								<div class="container">
				...
				<div class="slide">
					<div class="img--holder" data-bg="{{asset('front/images/content/slider/slide-03.jpg')}}"></div>
					<div class="slide-content center">
						<div class="vert-wrap container">
							<div class="vert">
								<div class="container">
				...
				<div class="col-md-6 mt-4 mt-md-0">
					<div class="video-box">
						<div class="video-box-poster">
							<img src="{{asset('front/images/content/video-poster.jpg')}}" alt="" class="img-fluid">
						</div>
						...
						<div class="video-box-bg"><img src="{{asset('front/images/content/video-poster-bg.png')}}" alt=""></div>
					</div>
					<!-- Video Modal -->
	...
	<div class="section">
		<div class="container-fluid px-0 text-image-block">
			<div class="row no-gutters">
				<div class="col-md-6 image-col"><img src="{{asset('front/images/content/why-choose-us.png')}}" alt=""></div>
	...
	<div class="section bg-grey py-0" id="faqSection">
		<div class="container-fluid px-0">
			<div class="row no-gutters">
				...
				<div class="col-xl-6 banner-left bg-cover order-1 order-xl-2" style="background-image: url(<?php echo asset('front/images/content/banner-left.jpg') ?>)"></div>
			</div>
		</div>
	</div>
	<!--//section faq-->
		...
		<div class="container">
			...
			<div class="row specialist-carousel js-specialist-carousel">
				<div class="col-sm-6 col-md-4 category1">
					<div class="doctor-box doctor-box-style2 text-center">
						<div class="doctor-box-photo">
							<img src="{{asset('front/images/content/doctor-01.jpg')}}" class="img-fluid" alt="">
						</div>
				...
				<div class="col-sm-6 col-md-4 category2">
					<div class="doctor-box doctor-box-style2 text-center">
						<div class="doctor-box-photo">
							<img src="{{asset('front/images/content/doctor-02.jpg')}}" class="img-fluid" alt="">
						</div>
						<div class="doctor-box-top">
				...
				<div class="col-sm-6 col-md-4 category2">
					<div class="doctor-box doctor-box-style2 text-center">
						<div class="doctor-box-photo">
							<img src="{{asset('front/images/content/doctor-03.jpg')}}" class="img-fluid" alt="">
						</div>
						<div class="doctor-box-top">
				...
				<div class="col-sm-6 col-md-4 category1">
					<div class="doctor-box doctor-box-style2 text-center">
						<div class="doctor-box-photo">
							<img src="{{asset('front/images/content/doctor-04.jpg')}}" class="img-fluid" alt="">
						</div>
						<div class="doctor-box-top">
							<h5 class="doctor-box-name">Dr. Robert Rush</h5>
							<div class="doctor-box-position">Psychiatrist</div>
				...
				<div class="col-sm-6 col-md-4 category1">
					<div class="doctor-box doctor-box-style2 text-center">
						<div class="doctor-box-photo">
							<img src="{{asset('front/images/content/doctor-05.jpg')}}" class="img-fluid" alt="">
						</div>
						<div class="doctor-box-top">
							<h5 class="doctor-box-name">Dr. Terri Williams</h5>
							<div class="doctor-box-position">Psychiatrist</div>
				...
				<div class="col-sm-6 col-md-4 category2">
					<div class="doctor-box doctor-box-style2 text-center">
						<div class="doctor-box-photo">
							<img src="{{asset('front/images/content/doctor-06.jpg')}}" class="img-fluid" alt="">
						</div>
						<div class="doctor-box-top">
	...
	<div class="section py-0" id="testimonialsSection">
		<div class="container-fluid px-0">
			<div class="row no-gutters">
				<div class="col-sm-6 order-1 bg-cover" style="background-image: url(<?php echo asset('front/images/content/reviews-bg.jpg')?>);">
		...
		<div class="container">
			...
			<div class="row blog-grid-full blog-grid-carousel-full js-blog-grid-carousel-full mt-lg-3">
				<div class="col-md-6 col-lg-4">
					<div class="blog-post blog-post-style2">
						<div class="post-image">
							<img src="{{asset('front/images/content/news-01.jpg')}}" alt="">
						</div>
				...
				<div class="col-md-6 col-lg-4">
					<div class="blog-post blog-post-style2">
						<div class="post-image">
							<img src="{{asset('front/images/content/news-02.jpg')}}" alt="">
						</div>
				...
				<div class="col-md-6 col-lg-4">
					<div class="blog-post blog-post-style2">
						<div class="post-image">
							<img src="{{asset('front/images/content/news-03.jpg')}}" alt="">
						</div>
	...
	<div class="section">
		<div class="container-fluid px-0">
			<div class="block-full-appointment bg-cover" style="background-image: url(<?php echo asset('front/images/content/online-appointment-bg.jpg') ?>)">
				<div class="container">
					<div class="row">
						<div class="col-sm-6">
	...
	<div class="section" id="contactSection">
		<div class="banner-contact-us" style="background-image: url(<?php echo asset('front/images/content/contact-bg.html') ?>)">
			<div class="container">
				<div class="row no-gutters">
		...
		<div class="row py-1 py-md-2 px-lg-0">
			...
			<div class="col-sm-6 col-lg-4">
				...
				<div class="footer-post d-flex">
					<div class="footer-post-photo"><img src="{{asset('front/images/content/footer-post-author-03.jpg')}}" alt="" class="img-fluid"></div>
				...
				<div class="footer-post d-flex">
					<div class="footer-post-photo"><img src="{{asset('front/images/content/footer-post-author-01.jpg')}}" alt="" class="img-fluid"></div>
					<div class="footer-post-text">
				...
				<div class="footer-post d-flex">
					<div class="footer-post-photo"><img src="{{asset('front/images/content/footer-post-author-02.jpg')}}" alt="" class="img-fluid"></div>
					<div class="footer-post-text">
			...
			<div class="col-sm-6 col-lg-4">
				...
				<ul class="icn-list">
					...
					<li><i class="icon-black-envelope"></i><a href="mailto:info@medera.net">info@medera.net</a></li>
				</ul>
			</div>
		</div>
	</div>
	<div class="footer-bottom">
		<div class="container">
			<div class="row text-center text-md-left">
				<div class="col-sm">Copyright © 2019 <a href="#">Medera</a><span>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;</span>
